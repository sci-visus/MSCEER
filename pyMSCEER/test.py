...
if __name__ == '__main__':
    ...
    with Timer() as t4:
        n0=int(0)
        for i in range(num_of_iterations):
            print fibonacci.fibonacci_iteration
            newval = fibonacci.fibonacci_iteration(i,N_MAX)
            print newval
            n0+= newval
    print str(n0) + ", " + str(t4.interval)

    with Timer() as t5:
        n0=fibonacci.fibonacci_full_iteration(int(num_of_iterations), int(N_MAX))
