...
namespace GInt {
	...
	public:
		...
		TopologicalExplicitDenseMeshFunction<TopologicalRegularGrid3D,float>* m_func;
	...
	public:
		...
		Topological2DRestrictedExpandingRegions(
			TopologicalExplicitDenseMeshFunction<TopologicalRegularGrid3D, float>* func,
		...
		TopologicalExplicitDenseMeshFunction<TopologicalRegularGrid3D, float>* GetFunction() { return m_func; }
