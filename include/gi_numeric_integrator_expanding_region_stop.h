...
namespace GInt {
    ...
    protected:
        ...
        int Inspect_Higher_Certains(INDEX_TYPE tid) {
            ...
            if (!has_extremal) {
				...
				Vec3l coords = m_grid->Coords(tid); coords.PrintInt();
                return -1;
            }
    ...
    public:
        ...
        NumericIntegratorExpandingRegionStop(RegularGridTrilinearFunction* func, RegularGrid3D* grid,  FLOATTYPE error_threshold, FLOATTYPE gradient_threshold, int interation_limit) :
